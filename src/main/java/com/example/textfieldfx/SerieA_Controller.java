...
public class SerieA_Controller {
    ...
    public void initialize() {
        ...
        getSerieA_Button.setOnMouseClicked(event -> {
    ...
    public void Standings_API (Integer usrLeagueSeason){
        ...
        try {
            Request request = new Request.Builder()
                    .url("https://api-football-v1.p.rapidapi.com/v3/standings?season=" + usrLeagueSeason + "&league=135")
                    .get()
    ...
    private void printToTable (JsonArray standingsArray0){
        ...
        SerieATable_TableView.getItems().clear();
        ...
        for (int i = 0; i < standingsArray_0.size(); i++) {
            ...
            SerieATable_TableView.getItems().add(standing);
    ...
    public void topScorer_API() throws IOException{
        ...
        Request topScorers_request = new Request.Builder()
                .url("https://api-football-v1.p.rapidapi.com/v3/players/topscorers?league=135&season="+ usrLeagueSeason)
                .get()
                .addHeader("X-RapidAPI-Key", APIKEY)
                .addHeader("X-RapidAPI-Host", "api-football-v1.p.rapidapi.com")
                .build();
    ...
    public void SerieAToBundesliga(MouseEvent e){
