...
public class Ligue1_Controller {
    ...
    public Label bundesliga_Label;

    @FXML
    public Button getLigue1_Button;
    public Button topScorer_Button;

    @FXML
    public ChoiceBox<Integer> season_choice;
    public ImageView topScorer_ImageView;
    public TableView<PremLeagueController.Standing> Ligue1Table_TableView;
    ...
    public Label ligue1TitlePage_Label;
    ...
    public void initialize() {
        ...
        getLigue1_Button.setOnMouseClicked(event -> {
    ...
    public void Standings_API (Integer usrLeagueSeason){
        ...
        try {
            Request request = new Request.Builder()
                    .url("https://api-football-v1.p.rapidapi.com/v3/standings?season=" + usrLeagueSeason + "&league=61")
                    .get()
    ...
    private void printToTable (JsonArray standingsArray0){
        ...
        Ligue1Table_TableView.getItems().clear();
        ...
        for (int i = 0; i < standingsArray_0.size(); i++) {
            ...
            Ligue1Table_TableView.getItems().add(standing);
    ...
    // ------------------------------------------------------------------------------------------------------------
    // ------------------------------------------------------------------------------------------------------------
    // API Call for Top Scorer using {league, year} for <Bundesliga>
    ...
    public void topScorer_API() throws IOException{
        ...
        Request topScorers_request = new Request.Builder()
                .url("https://api-football-v1.p.rapidapi.com/v3/players/topscorers?league=61&season="+ usrLeagueSeason)
                .get()
                .addHeader("X-RapidAPI-Key", APIKEY)
                .addHeader("X-RapidAPI-Host", "api-football-v1.p.rapidapi.com")
                .build();
    ...
    public void Ligue1ToLaLiga(MouseEvent e){
    ...
    // @forwardButton - null
    public void Ligue1ToBundesliga(MouseEvent e){

        try {

            // @ERR: change fxml path
