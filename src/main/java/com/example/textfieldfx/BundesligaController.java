...
public class BundesligaController {
    ...
    @FXML
    public Button getBundesliga_Button;
    public Button topScorer_Button;

    @FXML
    public ChoiceBox<Integer> season_choice;
    public ImageView topScorer_ImageView;
    public TableView<PremLeagueController.Standing> BundesligaTable_TableView;
    ...
    public void initialize() {
        ...
        getBundesliga_Button.setOnMouseClicked(event -> {
    ...
    public void Standings_API (Integer usrLeagueSeason){
        ...
        try {
            Request request = new Request.Builder()
                    .url("https://api-football-v1.p.rapidapi.com/v3/standings?season=" + usrLeagueSeason + "&league=78")
                    .get()
    ...
    private void printToTable (JsonArray standingsArray0){
        ...
        BundesligaTable_TableView.getItems().clear();
        ...
        for (int i = 0; i < standingsArray_0.size(); i++) {
            ...
            BundesligaTable_TableView.getItems().add(standing);
    ...
    public void topScorer_API() throws IOException{
        ...
        Request topScorers_request = new Request.Builder()
                .url("https://api-football-v1.p.rapidapi.com/v3/players/topscorers?league=78&season="+ usrLeagueSeason)
                .get()
                .addHeader("X-RapidAPI-Key", APIKEY)
                .addHeader("X-RapidAPI-Host", "api-football-v1.p.rapidapi.com")
                .build();
    ...
    public void BundesligaToLigue1(MouseEvent e){

        try {
            // @ERR: change path only this
    ...
    // @forwardButton - null
    public void BundesligaToSerieA(MouseEvent e){
